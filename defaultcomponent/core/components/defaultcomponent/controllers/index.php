 ...
 */
require_once dirname(dirname(__FILE__)).'/model/defaultcomponent/defaultcomponent.class.php';
$defaultcomponent = new defaultComponent($modx);
return $defaultcomponent->initialize('mgr');